...
if (isset($_POST['registrarse'])) {
    ...
    if ($crud->buscarUsuario($_POST['usuario'])) {
        ...
        header('Location: index.php?mensaje=El nombre de usuario ya existe');
    }
    ...
    if ($usuario->getId() != NULL) {
        ...
        header('Location: ./../'); //envia a la página que simula la cuenta
    } else {
        //header('Location: http://www.google.es');
        header('Location: ./../index.php?mensaje=Tu nombre de usuario o clave son incorrectos: '); // cuando los datos son incorrectos envia a la página de error
    }
